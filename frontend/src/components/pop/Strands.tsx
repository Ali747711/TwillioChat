// Strands — WebGL ribbon animation from React Bits (reactbits.dev), MIT.
// Adapted for this project: type-only imports (verbatimModuleSyntax) and the
// live-props ref is written in an effect (react-hooks/refs forbids render writes).
...
export default function Strands({
  ...
  // Keep the render loop's live snapshot in sync (effect, not render — the
